            ...
            <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                        ...
                        <p class="text-lg font-bold text-gray-800">
                            {{ \Carbon\Carbon::parse($shift->start_time)->format('d M Y, H:i') }}</p>
                    </div>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        ...
                        <p class="text-lg font-bold text-gray-800">Rp
                            {{ number_format($shift->starting_cash, 0, ',', '.') }}</p>
                    </div>
                </div>
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex justify-between items-center border-b pb-4">
                        ...
                        <span class="font-extrabold text-xl text-blue-600">Rp
                            {{ number_format($expectedCash, 0, ',', '.') }}</span>
                    </div>
                </div>
                ...
                <form action="{{ route('kasir.shift.update') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-400 mt-2 italic">*Hitung semua uang tunai (kertas & koin) yang ada di
                            laci sebelum mengakhiri shift.</p>
                    </div>

                    <div class="flex gap-4">
                        <a href="{{ route('kasir.transaksi') }}"
                            class="w-1/3 text-center bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-3 px-4 rounded-xl transition duration-200">
                            Batal
                        </a>
                        <button type="submit"
