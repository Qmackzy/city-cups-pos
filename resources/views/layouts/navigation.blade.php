<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="hidden sm:flex sm:items-center sm:ms-6">
        <x-dropdown align="right" width="48">
            ...
            <x-slot name="content">
                <x-dropdown-link :href="route('owner.laporan')">
                    {{ __('Laporan Penjualan') }}
                </x-dropdown-link>
                <x-dropdown-link :href="route('owner.shifts.index')">
                    {{ __('Laporan Shift') }}
                </x-dropdown-link>
...
@if(Auth::user()->role == 'kasir')
    ...
    <x-nav-link :href="route('kasir.shift.close')" :active="request()->routeIs('kasir.shift.close')" class="text-red-600 hover:text-red-800">
